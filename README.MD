...
- Date:         22/08/2025  
- Developer:    JossieB
- Target:       Generate a videoclip that can be used as Karaoke clip
-----------------------

- Version:      1.0
- Date:         27/08/2025  
- Developer:    JossieB
- Target:       Sync words or lines with vocal part, you choose!
-----------------------

- Version:      1.1
- Date:         26/09/2025  
- Developer:    JossieB
- Target:       Add minimal time per text line and check for overlap
